...
struct myExampleTaskNew {
  ...
  PROCESS_SWITCH(myExampleTaskNew, processReco, "process reconstructed information", true);
  ...
  PROCESS_SWITCH(myExampleTaskNew, processSim, "process pure simulation information", true);
};

WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  return WorkflowSpec{
    adaptAnalysisTask<myExampleTaskNew>(cfgc)};
}